...
func (c *SnippetClient) UpdateOne(s *Snippet) *SnippetUpdateOne {
	mutation := newSnippetMutation(c.config, OpUpdateOne, withSnippet(s))
	return &SnippetUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *SnippetClient) UpdateOneID(id uuid.UUID) *SnippetUpdateOne {
...
func (c *SnippetClient) DeleteOneID(id uuid.UUID) *SnippetDeleteOne {
...
func (c *SnippetClient) Get(ctx context.Context, id uuid.UUID) (*Snippet, error) {
	return c.Query().Where(snippet.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *SnippetClient) GetX(ctx context.Context, id uuid.UUID) *Snippet {
